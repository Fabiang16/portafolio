    ...
    <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-12 lg:gap-x-12 lg:gap-y-12">
      ...
      <div className="order-1 lg:order-2 lg:col-span-5 lg:col-start-8 flex flex-col gap-10">
        ...
        <div className="flex flex-col gap-6 pl-2">
          ...
          {/* X (Twitter) Link */}
          <SocialLink href="https://x.com/elfabi06" icon={
          ...
          {/* Instagram Link */}
          <SocialLink href="https://instagram.com/godoy_fabi/" icon={
          ...
          {/* GitHub Link */}
          <SocialLink href="https://github.com/Fabiang16" icon={
          ...
          {/* LinkedIn Link */}
          <SocialLink href="https://linkedin.com/in/fabian-godoy-morales-a9b6ba2a0" icon={
